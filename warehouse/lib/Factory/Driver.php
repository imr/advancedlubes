 ...
 * @package  Warehouse
 */
class Warehouse_Factory_Driver extends Horde_Core_Factory_Injector
{
    /**
     * @var array
     */
    ...
    /**
     * Return an Warehouse_Driver instance.
     *
     * @return Warehouse_Driver
     */
        ...
        if (empty($this->_instances[$signature])) {
            ...
            case 'Sql':
                try {
                    ...
                    throw new Warehouse_Exception($e);
                }
                $params = array('db' => $db);
                break;
            case 'Ldap':
                try {
                    $params = array('ldap' => $injector->getIntance('Horde_Core_Factory_Ldap')->create('warehouse', 'storage'));
                } catch (Horde_Exception $e) {
                    throw new Warehouse_Exception($e);
                }
                break;
            }
            $class = 'Warehouse_Driver_' . $driver;
