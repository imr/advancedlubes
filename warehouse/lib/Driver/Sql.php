<?php
/**
 * Warehouse storage implementation for the Horde_Db database abstraction layer.
 *
 ...
 * @package  Warehouse
 */
class Warehouse_Driver_Sql extends Warehouse_Driver
{
    /**
