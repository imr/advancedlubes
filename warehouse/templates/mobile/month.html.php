<div data-role="page" id="monthview">
  <div data-role="header">
    ...
    <div class="warehouseMonthHeader ui-bar-a">
     <a href="#" data-role="button" data-icon="arrow-l" data-iconpos="notext" class="warehouseMinicalPrev" title="<?php echo _("Previous month") ?>">&lt;</a>
     <span class="warehouseMinicalDate"><?php echo $this->today->format('F Y') ?></span>
     <a href="#" data-role="button" class="warehouseMinicalNext" data-icon="arrow-r" data-iconpos="notext" title="<?php echo _("Next month") ?>">&gt;</a>
    </div>
  </div>
  <div id="monthcontent">
    <div id="warehouseMinical" class="warehouseMinical">
      <table>
        <thead>
          <tr>
